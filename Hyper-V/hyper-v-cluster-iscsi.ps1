...
.LINK
https://learn.microsoft.com/en-us/powershell/module/iscsitarget/new-iscsivirtualdisk?view=windowsserver2025-ps
...
try {
    ...
    "IPv6Address:2a01:e0a:2db:ad40:8d17:465e:219d:284a"
    )
